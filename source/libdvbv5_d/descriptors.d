 ...
 * @ingroup dvb_table
 */
enum DVB_MAX_PAYLOAD_PACKET_SIZE = 4096;
 ...
 * @ingroup dvb_table
 */
extern __gshared const(dvb_table_init_func)[256] dvb_table_initializers;
 ...
 * @param desc		struct dvb_desc pointer
 */
alias dvb_desc_init_func = int function (
    dvb_v5_fe_parms* parms,
    const(ubyte)* buf,
    dvb_desc* desc);
 ...
 * @param desc		struct dvb_desc pointer
 */
alias dvb_desc_print_func = void function (
    dvb_v5_fe_parms* parms,
    const(dvb_desc)* desc);
 ...
 * @ingroup dvb_table
 */
extern __gshared const(dvb_descriptor)[] dvb_descriptors;
