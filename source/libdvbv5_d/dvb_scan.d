 ...
 */
int dvb_read_sections (
    dvb_v5_fe_parms* parms,
    int dmx_fd,
    dvb_table_filter* sect,
    uint timeout);
 ...
 */
dvb_v5_descriptors* dvb_get_ts_tables (
    dvb_v5_fe_parms* parms,
    int dmx_fd,
    uint delivery_system,
    uint other_nit,
 ...
 * @endcode
 */
void dvb_add_scaned_transponders (
    dvb_v5_fe_parms* parms,
    dvb_v5_descriptors* dvb_scan_handler,
...
int dvb_new_freq_is_needed (
    dvb_entry* entry,
    dvb_entry* last_entry,
    uint freq,
    dvb_sat_polarization pol,
    int shift);

dvb_entry* dvb_scan_add_entry (
    dvb_v5_fe_parms* parms,
    dvb_entry* first_entry,
    dvb_entry* entry,
    uint freq,
...
dvb_entry* dvb_scan_add_entry_ex (
    dvb_v5_fe_parms* parms,
    dvb_entry* first_entry,
    dvb_entry* entry,
    uint freq,
